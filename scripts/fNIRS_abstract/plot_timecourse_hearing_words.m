...
SubjectName   = {'Subject05'}; %% Subject02
...
channel_file = {'Subject05/Subj5_Nph2014_HW1_dOD__motioncorr_band_scr_Hb/channel_nirsbrs.mat'};
sFiles = { 'Subject05/Subj5_Nph2014_HW1_dOD__motioncorr_band_scr_Hb/data_hb_251014_1642.mat'};

OPTIONS.selected_channel = 'S17D10';
OPTIONS.TimeSegment      = [0 209];
...
sFiles{1} = {...
    'Subject05/Subj5_Nph2014_HW1_dOD__motioncorr_band_scr/results_NIRS_MNE_sources____HbO_250718_1338_low.mat', ...
    'Subject05/Subj5_Nph2014_HW1_dOD__motioncorr_band_scr/results_NIRS_MNE_sources____HbR_250718_1338_low.mat'};


sFiles{2} = {...
    'Subject05/Subj5_Nph2014_HW1_dOD__motioncorr_band_scr/results_NIRS_wMEM___smooth=0.6_DWT_j1__2__3__4__5__6__7__8_____HbO_250903_0034_low.mat', ...
    'Subject05/Subj5_Nph2014_HW1_dOD__motioncorr_band_scr/results_NIRS_wMEM___smooth=0.6_DWT_j1__2__3__4__5__6__7__8_____HbR_250903_0034_low.mat'};
...
%%
channel_file = {'Subject05/Subj5_Nph2014_HW1_dOD__motioncorr_band_scr_Hb/channel_nirsbrs.mat'};
sFiles = { 'Subject05/Subj5_Nph2014_HW1_dOD__motioncorr_band_scr_Hb/data_hb_250811_1706.mat'};
...
function plot_timecouse_channels(channel_file, sFile, OPTIONS)
    ...
    assert(~isempty(iChannels), '%s not found', OPTIONS.selected_channel)
    ...
    if isempty(sData.Events) || ~any(strcmp( {sData.Events.label}, 'task'))
...
function  plot_timecourse(SubjectName, sFiles, sFiles_label, OPTIONS)
    ...
    Scouts      = sCortex.Atlas(strcmp({sCortex.Atlas.Name},'User scouts_05')).Scouts;
    ROI         = Scouts( strcmpi({Scouts.Label}, 'BOLD_R_rest'));
    ...
    for k = 1:length(sFiles)
        ...
        norm_factor = max(max(HbO), max(HbR));
        HbO = HbO ./ norm_factor; 
        HbR = HbR ./ norm_factor; 
        ...
        if isempty(sData_head.Events) || ~any(strcmp( {sData_head.Events.label}, 'task'))
