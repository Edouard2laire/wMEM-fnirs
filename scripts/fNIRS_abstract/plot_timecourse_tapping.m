...
OPTIONS.color_blue =  [ 145,191,219; ...
                      69,117,180 ;...
                      224,243,248] ./ 255;
OPTIONS.LineWidth = 2.5;
OPTIONS.fontsize  = 20;
OPTIONS.output_folder = fullfile('/Users/edelaire1/Documents/Etude/04_PHD/Abstract/2026_fNIRS_china/figures','tapping');
...
channel_file = {'sub-01/sub-01_task-tapping_run-01_preproc_Hb/channel_nirsbrs.mat'};
sFiles = { 'sub-01/sub-01_task-tapping_run-01_preproc_Hb/data_hb_250902_1650.mat'};
...
sFiles{1} =  {...
    'sub-01/sub-01_task-tapping_run-01_preproc/results_NIRS_MNE_sources____HbO_250902_1631_low_winavg_250902_1642.mat', ...
    'sub-01/sub-01_task-tapping_run-01_preproc/results_NIRS_MNE_sources____HbR_250902_1631_low_winavg_250902_1643.mat'};

sFiles{2} =   {...
    'sub-01/sub-01_task-tapping_run-01_preproc/results_NIRS_wMEM___smooth=0.6_DWT_j1___2___3___4___5___6___7___8___9__10_____HbO_250902_1638_low_winavg_250902_1643.mat', ...
    'sub-01/sub-01_task-tapping_run-01_preproc/results_NIRS_wMEM___smooth=0.6_DWT_j1___2___3___4___5___6___7___8___9__10_____HbR_250902_1638_low_winavg_250902_1643.mat'};

sFiles_label                   = { 'b. MNE',  'c. wMEM'}; 
...
hFig = figure('Units','pixels','Position', getFigureSize(24, 12));
...
function plot_timecouse_channels(channel_file, sFile, OPTIONS)
    ...
    if OPTIONS.plot_montage
        ...
        iChannel = find(contains({sChannels.Channel.Name}, OPTIONS.selected_channel));
        locPairSrc = sChannels.Channel(iChannel(1)).Loc(:,1)';
        locPairDet = sChannels.Channel(iChannel(1)).Loc(:,2)';
        ...
        % Hide channel name
        set(findobj(hFig,  'Tag', 'NirsCapText'), 'Visible', 'off')
...
function  plot_timecourse(SubjectName, sFiles, sFiles_label, OPTIONS)
    ...
    for k = 1:length(sFiles)
        ...
        hold on;
        plot(Time, HbO , 'DisplayName',[ sFiles_label{k} ' - HbO'], 'LineWidth', OPTIONS.LineWidth, 'Color',OPTIONS.color_red(k,:));
        plot(Time, HbR , 'DisplayName',[ sFiles_label{k} ' - HbO'], 'LineWidth', OPTIONS.LineWidth, 'Color',OPTIONS.color_blue(k,:));
    end

    legend({'MNE - HBO', 'MNE - HBR', 'wMEM - HBO', 'wMEM - HBR' })
    xlim(OPTIONS.TimeSegment);
    ylim([-1.5 1.5]); yticks([-1 0 1])
    ...
    xlabel('Time(s)');
    ylabel('Amplitude');
    set(gca,  'Color',[1,1,1],   'fontsize', OPTIONS.fontsize,  'LineWidth',OPTIONS.LineWidth);
