...
% BOLD
sFiles{1}   = { 'Group_analysis/@intra/results_average_251007_1426.mat'};

% MNE
sFiles{2} = {...
    'Group_analysis/@intra/results_average_251007_1428.mat', ...
    'Group_analysis/@intra/results_average_251007_1429.mat'};

% wMEM
sFiles{3} = {...
                'Group_analysis/@intra/results_average_250910_1136.mat', ...
                'Group_analysis/@intra/results_average_250910_1137.mat'};
...
sFiles_label                   = {'a. BOLD | left', 'a. MNE | left',  'a. wMEM | left'};
fig = figure('units','normalized','outerposition',[0 0 0.35 1]); hold on;
plot_timecourse(SubjectName, sFiles, sFiles_label, OPTIONS);
saveas(fig,fullfile(OPTIONS.output_folder, 'reconstructed_signal_left_cortex_avg.svg'));
...
fig = figure('units','normalized','outerposition',[0 0 0.35 1]); hold on;
plot_timecourse(SubjectName, sFiles, sFiles_label, OPTIONS);
saveas(fig,fullfile(OPTIONS.output_folder, 'reconstructed_signal_right_cortex_avg.svg'));
...
sFiles{1} = {
                'Group_analysis/@intra/results_average_250910_1140.mat', ...
                'Group_analysis/@intra/results_average_250910_1139.mat'};
...
function OPTIONS = get_options()
    ...
    OPTIONS.fontsize    = 20;
    OPTIONS.output_folder = fullfile('/Users/edelaire1/Documents/Etude/04_PHD/Abstract/2026_fNIRS_china/figures','hearing_words_group');
