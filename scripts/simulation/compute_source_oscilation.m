...
sFiles = {...
    'sub-02/simulation_wake_osc_0.00dB_left_medium/data_sim_250420_1471.mat'};

timewindow_full      = [5, 330];
...
for iFile = 1:length(sFiles)
    ...
    selected_scales = [1:8]; alpha_init = 7; neighborhood_order = 6; normalization = 'adaptive';
    compute_wMEM(sInput, timewindow_full, baselinewindow_full, neighborhood_order, selected_scales, alpha_init, normalization);
end
