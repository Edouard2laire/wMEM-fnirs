sFiles = { 'sub-02/sub-02_task-rest_run-01_pipeline-preproc-TFR/data_block001.mat'};


timewindow_full      = [5, 335];
...
selected_scales = [1:ag9]; alpha_init = 7; neighborhood_order = 6; normalization = 'adaptive';
...
function sFilesMEM = compute_wMEM(sImput, timewindow_full, baselinewindow_full, neighborhood_order, selected_scales, alpha_init, normalization)
    ...
    mem_option.optional = struct_copy_fields(mem_option.optional, ...
                                        ...
                                        "baseline_shuffle", 1, ...
                                        "BaselineSegment", timewindow_full , ...
                                        "baseline_shuffle_windows",  100, ...
                                        'display',         0));
