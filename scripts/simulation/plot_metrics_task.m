...
g.set_order_options('color',{'cMEM' 'MNE' 'wMEM'});
...
g(1,1) = plot_boxplot(data_all_select2, {'DLE'},  'method');  g(1,1).set_title('a. DLE (mm)'); g(1,1).no_legend()
g(1,2) = plot_boxplot(data_all_select2, { 'SD'},  'method');  g(1,2).set_title('b. SD (mm)');  g(1,2).no_legend()
g(1,3) = plot_boxplot(data_all_select2, { 'correlation'},  'method'); g(1,3).set_title('c. Correlation (%)');
